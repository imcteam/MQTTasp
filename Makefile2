...
# for imc (imc@imc) on Mon Apr 12 11:32:45 2021
...
# this project:
GENERATED_SOURCES = MyExample.cc
GENERATED_HEADERS = MyExample.hh
...
#
SOLARIS_LIBS = -lsocket -lnsl -lxml2 -lpaho-mqtt3cs
SOLARIS8_LIBS = -lsocket -lnsl -lxml2 -lpaho-mqtt3cs
LINUX_LIBS = -lxml2 -lpaho-mqtt3cs
FREEBSD_LIBS = -lxml2 -lpaho-mqtt3cs
WIN32_LIBS = -lxml2 -lpaho-mqtt3cs
